/**
 * Print Server Full Changelog Page
 * Histórico completo de versões do OpenSea Print Server
 */
...
export default function PrintServerChangelogPage() {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Todas as versões publicadas do OpenSea Print Server
                </p>
              </div>
            </div>
