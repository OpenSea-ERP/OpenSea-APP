  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        id: 'planning',
        title: 'Planejamento',
        description: 'Cronogramas, programações e sequenciamento',
        icon: Gauge,
      ...
      },
      {
        id: 'quality',
        title: 'Qualidade',
        description: 'Inspeções, bloqueios e registros de defeitos',
        icon: FlaskConical,
      ...
      },
      {
        id: 'costing',
        title: 'Custos',
        description: 'Custos planejados e realizados por ordem',
        icon: DollarSign,
        href: '/production/costing',
        gradient: 'from-emerald-500 to-emerald-600',
        hoverBg: 'hover:bg-emerald-50 dark:hover:bg-emerald-500/10',
        permission: PRODUCTION_PERMISSIONS.COSTING.ACCESS,
      },
      {
        id: 'textile',
        title: 'Confecção',
        description: 'Plano de corte e tickets de pacote',
        icon: Scissors,
        href: '/production/textile',
