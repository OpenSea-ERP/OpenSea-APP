 ...
 */
export const BIN_CELL_COLORS: Record<Exclude<OccupancyLevel, 'empty'>, string> = {
  low: 'bg-emerald-200 dark:bg-emerald-800 border-emerald-300 dark:border-emerald-700',
  medium: 'bg-amber-200 dark:bg-amber-800 border-amber-300 dark:border-amber-700',
...
export const OCCUPANCY_LEGEND = [
  { label: 'Vazio', color: 'bg-gray-100 dark:bg-gray-800', border: 'border-gray-200 dark:border-gray-700', dashed: true },
  { label: 'Baixo', color: 'bg-emerald-200 dark:bg-emerald-800', border: 'border-emerald-300 dark:border-emerald-700' },
  { label: 'Médio', color: 'bg-amber-200 dark:bg-amber-800', border: 'border-amber-300 dark:border-amber-700' },
  { label: 'Alto', color: 'bg-orange-200 dark:bg-orange-800', border: 'border-orange-300 dark:border-orange-700' },
  { label: 'Cheio', color: 'bg-rose-200 dark:bg-rose-800', border: 'border-rose-300 dark:border-rose-700' },
  { label: 'Bloqueado', color: 'bg-gray-200 dark:bg-gray-700', border: 'border-gray-300 dark:border-gray-600' },
] as const;
